...
<body>
  <table style="padding: 20px;">
    <tbody>
      ...
      <tr>
        <td>
          <b>Para confirmar al usuario haga <a style="text-decoration: none; margin-top: 10px;" href='{!! $url !!}'>click aquí</a></b>
        </td>
      </tr>
	  <tr>
        <td>
          <b>Para rechazar al usuario haga <a style="text-decoration: none; margin-top: 10px;" href='{!! $url2 !!}'>click aquí</a></b>
        </td>
      </tr>
    </tbody>
  </table>
