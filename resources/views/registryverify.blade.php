...
<body>
    ...
    <div class="nav-wrapper container">
      ...
      <div class="section">
        ...
        <div class="row">
          <p class="text-confirm"><b>Usuario verificado correctamente</b>
          <br/>La dirección de la ETSI comprobará si es alumno del centro, se le notificará mediante un correo electrónico.</p>
        </div>
